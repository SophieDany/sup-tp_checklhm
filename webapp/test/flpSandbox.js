		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comkoerberchecklhm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkoerberchecklhm-display": {
								"semanticObject": "comkoerberchecklhm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.koerber.checklhm",
									"url": sap.ui.require.toUrl("com/koerber/checklhm")
								}
							}
						}
					}
